...
class OsControllerTest < ActionController::TestCase
  ...
  test "should create o" do
    assert_difference('O.count') do
      post :create, o: { cliente: @o.cliente, itens: @o.itens, numero: @o.numero, obs: @o.obs, status: @o.status }
    end
  ...
  test "should update o" do
    patch :update, id: @o, o: { cliente: @o.cliente, itens: @o.itens, numero: @o.numero, obs: @o.obs, status: @o.status }
    assert_redirected_to o_path(assigns(:o))
  end
